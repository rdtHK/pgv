...
var seed = __importStar(require("./seed"));
...
program.command('run').action(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, migration.run()];
            case 1:
                _a.sent();
                return [4 /*yield*/, seed.run()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
program.command('refresh').action(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, migration.clear()];
            case 1:
                _a.sent();
